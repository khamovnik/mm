...
Код программы для первого случая $\frac{dn}{dt} = (0.64 + 0.00014n(t))(N-n(t))$:
...
Код программы для второго случая $\frac{dn}{dt} = (0.000014 + 0.63n(t))(N-n(t))$:
...
Код программы для третьего случая $\frac{dn}{dt} = (0.7 * t + 0.4\cos{t}* n(t))(N-n(t))$:

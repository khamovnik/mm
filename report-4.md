...
3. Колебания гармонического осциллятора c затуханием и под действием внешней силы $\ddot{x}+\dot{x}+11x=2cos(t)$

На интервале $t\in [0;66]$ (шаг $0.05$) с начальными условиями $x_0=0, y_0=0$.
